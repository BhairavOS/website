    ...
    <div class="footer-gray-container1">
      <div class="footer-gray-container2">
        <div class="footer-gray-container3">
          <span class="footer-gray-text10">Soft UI Design System</span>
          <span class="footer-gray-text11">Social</span>
          <div class="footer-gray-container4">
            ...
            <svg viewBox="0 0 950.8571428571428 1024" class="footer-gray-icon12">
              <path
              ...
              ></path></svg
            ><svg viewBox="0 0 877.7142857142857 1024" class="footer-gray-icon14">
              <path
              ...
              ></path></svg
            ><svg viewBox="0 0 1024 1024" class="footer-gray-icon16">
              <path
              ...
              ></path></svg
            ><svg viewBox="0 0 1024 1024" class="footer-gray-icon18">
              <path
        ...
        <div class="footer-gray-container5">
          <div class="footer-gray-container6">
            <span class="footer-gray-text12 Large">Company</span>
            <span class="footer-gray-text13 Large">About Us</span>
            <span class="footer-gray-text14 Large">Freebies</span>
            <span class="footer-gray-text15 Large">Premium Tools</span>
            <span class="footer-gray-text16 Large">Blog</span>
          </div>
          <div class="footer-gray-container7">
            <span class="footer-gray-text17 Large">Resources</span>
            <span class="footer-gray-text18 Large">Login</span>
            <span class="footer-gray-text19 Large">Register</span>
            <span class="footer-gray-text20 Large">About</span>
          </div>
          <div class="footer-gray-container8">
            <span class="footer-gray-text21 Large">Help &amp; Support</span>
            <span class="footer-gray-text22 Large">Contact Us</span>
            <span class="footer-gray-text23 Large">Knowledge Center</span>
            <span class="footer-gray-text24 Large">Custom Development</span>
            <span class="footer-gray-text25 Large">Sponsorships</span>
          </div>
          <div class="footer-gray-container9">
            <span class="footer-gray-text26 Large">Legal</span>
            <span class="footer-gray-text27 Large">Terms &amp; Conditions</span>
            <span class="footer-gray-text28 Large">Privacy Policy</span>
            <span class="footer-gray-text29 Large">Licenses (EULA)</span>
          </div>
        </div>
      </div>
      <span class="footer-gray-text30 Small">
        <span>
          All rights reserved. Copyright © 2021 Soft UI Design System by
          <span v-html="rawzxi6"></span>
        </span>
        <span class="footer-gray-text32">Creative Tim</span>
        <span>.</span>
      </span>
    </div>
  </footer>
