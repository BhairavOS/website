    ...
    <nav class="header-nav">
      <div class="header-container1">
        ...
        <div class="header-menu1">
          ...
          <router-link to="/profile" class="header-navlink3 Large">
            Profile
          </router-link>
          <router-link to="/coming-soon" class="header-navlink4 Large">
            Coming Soon
          </router-link>
        </div>
    ...
    <div data-role="MobileMenu" class="header-mobile-menu">
      ...
      <div class="header-mid">
        <div class="header-menu2">
          <router-link to="/" class="header-navlink6 Large">Home</router-link>
          <router-link to="/profile" class="header-navlink7 Large">
            Profile
          </router-link>
          <router-link to="/coming-soon" class="header-navlink8 Large">
            Coming Soon
          </router-link>
        </div>
      </div>
