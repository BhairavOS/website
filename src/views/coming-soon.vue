    ...
    <div class="coming-soon-container2">
      <div class="coming-soon-main">
        <div class="coming-soon-container3">
          <h1 class="coming-soon-text1 HeadingOne">You Work With</h1>
          <h1 class="coming-soon-text2">Soft Design System</h1>
          <p class="coming-soon-text3 Lead">
            <span class="coming-soon-text4">
              The time is now for it be okay to be great. Subscribe now and get
              notified when it&apos;s launched!
            </span>
          </p>
          <div class="coming-soon-container4">
            <input
              type="text"
        ...
        <div class="coming-soon-grid">
          ...
          <img
            alt="image"
            src="/iphone-1-1000w.png"
            class="coming-soon-image16"
          />
          <img
            alt="image"
            src="/iphone-3-1000w.png"
            class="coming-soon-image17"
          />
          <img
            alt="image"
            src="/iphone-2-1000w.png"
            class="coming-soon-image18"
          />
          <img
            alt="image"
            src="/iphone-4-1000w.png"
            class="coming-soon-image19"
          />
          <img
            alt="image"
            src="/iphone-1-1000w.png"
            class="coming-soon-image20"
          />
          <img
            alt="image"
            src="/iphone-3-1000w.png"
            class="coming-soon-image21"
          />
          <img
            alt="image"
            src="/iphone-4-1000w.png"
            class="coming-soon-image22"
          />
          <img
            alt="image"
            src="/iphone-1-1000w.png"
            class="coming-soon-image23"
          />
          <img
            alt="image"
            src="/iphone-3-1000w.png"
            class="coming-soon-image24"
          />
          <img
            alt="image"
            src="/iphone-2-1000w.png"
            class="coming-soon-image25"
          />
        </div>
      </div>
    </div>
