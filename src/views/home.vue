<template>
  <div class="home-container10">
    ...
    <section class="home-container15">
      <div class="home-container16">
        <h1 class="home-text15 HeadingOne">
          <span class="home-text16">From nothing to something</span>
        </h1>
      ...
      <div class="home-container17">
        <div class="home-container18">
          ...
          <span class="home-text19 Small">
            ...
            <br />
            <span class="home-text22">-NOAA</span>
          </span>
    ...
    <section class="home-testimonials">
      <div class="home-container22">
        <div class="home-container23">
          <div class="home-container24">
            <h2 class="home-text33 HeadingOne">Work with us</h2>
            <p class="home-text34 Lead">
              <span class="home-text35">
                Whatever your qualification is - we got you!
              </span>
            </p>
            <p class="home-text36 Body">
            ...
            <p class="home-text38">Mark Jojansen</p>
            <p class="home-text39 Small">Project manager, Atlassian</p>
            <div class="home-container25">
              <img alt="image" src="/team-4-200h.jpg" class="home-image18" />
              <div class="home-container26"></div>
              <img alt="image" src="/team-3-200h.jpg" class="home-image19" />
              <div class="home-container27"></div>
              <img alt="image" src="/team-2-200h.jpg" class="home-image20" />
            </div>
          </div>
        </div>
          ...
          <div class="home-container28">
            <div class="home-container29">
              <div class="home-container30">
                <img alt="image" src="/logo-asana.svg" class="home-image21" />
              </div>
              <div class="home-container31">
                <img alt="image" src="/logo-slack.svg" class="home-image22" />
              </div>
            ...
            <div class="home-container33">
              <div class="home-container34">
                <img alt="image" src="/logo-shopify.svg" class="home-image24" />
              </div>
              ...
              <div class="home-container36">
                <img alt="image" src="/logo-invision.svg" class="home-image26" />
              </div>
            </div>
            <div class="home-container37">
              <div class="home-container38">
                <img alt="image" src="/logo-attlasian.svg" class="home-image27" />
              </div>
              <div class="home-container39">
                <img alt="image" src="/logo-weave.svg" class="home-image28" />
              </div>
            </div>
          </div>
        </div>
      ...
      <img alt="image" src="/waves-white.svg" class="home-image29" />
    ...
    <section class="home-contaier">
      <div class="home-container40">
        ...
        <h2 class="home-text40 HeadingTwo">
          <span class="home-text41">Beware The Components</span>
        </h2>
        <h3 class="home-text42 HeadingTwo">
          <span class="home-text43">How To Handle Them</span>
          <br />
        </h3>
      ...
      <div class="home-container42">
        <div class="home-container43">
          <div class="home-container44"></div>
          <div class="home-container45">
            <svg viewBox="0 0 987.4285714285713 1024" class="home-icon3">
              <path
            ...
            <h1 class="home-text46 HeadingOne">Search and Discover!</h1>
      ...
      <div class="home-container47">
        ...
        <div class="home-container49">
          <div class="home-container50"></div>
          <div class="home-container51">
            <svg viewBox="0 0 1152 1024" class="home-icon5">
              <path
            ...
            <h1 class="home-text50 HeadingOne">Talk and Meet!</h1>
